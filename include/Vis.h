...
#include "vex.h"
vex::vision::signature RING = vex::vision::signature (1, 183, 1659, 921, 2473, 7909, 5191, 1.3, 0);
...
vex::vision Vis = vex::vision (vex::PORT15, 61, RING, SIG_2, SIG_3, SIG_4, SIG_5, SIG_6, SIG_7);
